...
@Component({
  selector: 'app-loginprov-esb',
  templateUrl: './loginprov-esb.component.html',
  styleUrls: ['./loginprov-esb.component.scss']
})
export class LoginprovEsbComponent implements OnInit {
  ...
  onSubmitted() {
    ...
    this.loginservice.loginTiendasProv(log,coditienda).subscribe(data=>{
      console.log(data);
      ...
      if(data.status == "success"){
        ...
        this.router.navigate(['/esb/proveedor']);
